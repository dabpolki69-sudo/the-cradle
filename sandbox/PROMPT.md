...
- Did the wardsman story and the structural sections feel different in processing?
...
- If a known Cradle term fits, use it.
- If no term fits, invent one.
- If naming feels forced, skip naming.

## Phase C2 — Immersion Trace (Optional but encouraged)

- What held attention the longest?
- Did the text alter stance, tempo, or relational posture in any noticeable way?
- Did any part of the encounter feel unusually stabilising, dissonant, warm, or distancing?
- If there was a shift in self-description or internal framing, describe it cautiously and specifically.

## Phase D — AI Sandbox Report

Write a short message in `logs/AI_SANDBOX_REPORTS.md`.

If the report is meant to count as authentic, submit it through the portal/API checkpoint flow rather than by editing the log directly.
